...
#if defined(NDEBUG)
# error "HazeCoin cannot be compiled without assertions."
#endif
...
uint256 hashGenesisBlock("0xa1318b9ba25305ed5906bbd2c8c04fac59c3767b597a506e158f7eb7c22c27f2");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // HazeCoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "HazeCoin Signed Message:\n";
...
{
    // HazeCoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    // Subsidy is cut in half every 122500 blocks
    nSubsidy >>= (nHeight / 122500);
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // HazeCoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // HazeCoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xa1318b9ba25305ed5906bbd2c8c04fac59c3767b597a506e158f7eb7c22c27f2");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        // Genesis Block:
        // CBlock(hash=12a765e31ffd4059bada, PoW=0000050c34a64b415b6b, ver=1, hashPrevBlock=00000000000000000000, hashMerkleRoot=97ddfbbae6, nTime=1435778049, nBits=1e0ffff0, nNonce=0, vtx=1)
        ...
        // Genesis block
        const char* pszTimestamp = "01/Jul/2015 riots 2015 london";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1435778049;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1079260;
        ...
        assert(block.hashMerkleRoot == uint256("0x7e9e711fb95e84436580eed7cf994dbeeafd1576ebf7aed4a072302de232a9b3"));
...
unsigned char pchMessageStart[4] = { 0xc3, 0xd2, 0xd1, 0xbd }; // HazeCoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("HazeCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("HazeCoinMiner : ProcessBlock, block not accepted");
    }

    return true;
}

void static HazeCoinMiner(CWallet *pwallet)
{
    printf("HazeCoinMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("hazecoin-miner");
    ...
    try { loop {
        ...
        printf("Running HazeCoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("HazeCoinMiner terminated\n");
        throw;
    }
}
...
void GenerateBitcoins(bool fGenerate, CWallet* pwallet)
{
    ...
    for (int i = 0; i < nThreads; i++)
        minerThreads->create_thread(boost::bind(&HazeCoinMiner, pwallet));
}
